	...
	public function VerPerfilDoctorC(){
		...
		echo '<tr>
				...
				if($resultado["foto"] == ""){
					...
					echo '<td><img src="http://localhost:8081/clinica/Vistas/img/defecto.png" width="40px"></td>';
				...
				<td>
					...
					<a href="http://localhost:8081/clinica/perfil-D/'.$resultado["id"].'">
					...
					<h3>Cambiar Consultorio</h3>
						...
						<div class="col-md-6 col-xs-12">
							...
							if($resultado["foto"] == ""){
								...
								echo '<img src="http://localhost:8081/clinica/Vistas/img/defecto.png" class="img-responsive" width="200px">';

							}else{

								echo '<img src="http://localhost:8081/clinica/'.$resultado["foto"].'" class="img-responsive" width="200px">';
		...
		if(isset($_POST["Did"])){
			...
			if(isset($_FILES["imgPerfil"]["tmp_name"]) && !empty($_FILES["imgPerfil"]["tmp_name"])){
				...
				if($_FILES["imgPerfil"]["type"] == "image/png"){
					...
					$rutaImg = "Vistas/img/Doc-".$nombre.".png";
				...
				if($_FILES["imgPerfil"]["type"] == "image/jpeg"){
					...
					$rutaImg = "Vistas/img/Doc-".$nombre.".jpg";
			...
			if($resultado == true){
				...
				window.location = "http://localhost:8081/clinica/perfil-D/'.$resultado["id"].'";
				</script>';
