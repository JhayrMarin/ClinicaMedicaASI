	...
	public function VerPerfilPacienteC(){
		...
		echo '<tr>
				...
				<td>
					...
					<a href="http://localhost:8081/clinica/perfil-P/'.$resultado["id"].'">
					...
					<div class="row">
						...
						<div class="col-md-6 col-xs-12">
							...
							if($resultado["foto"] != ""){
								...
								echo '<img src="http://localhost:8081/clinica/'.$resultado["foto"].'" width="200px" class="img-responsive">';

							}else {

								echo '<img src="http://localhost:8081/clinica/Vistas/img/defecto.png" width="200px" class="img-responsive">';
		...
		if(isset($_POST["Pid"])){
			...
			if(isset($_FILES["imgPerfil"]["tmp_name"]) && !empty($_FILES["imgPerfil"]["tmp_name"])){
				...
				if($_FILES["imgPerfil"]["type"] == "image/png"){
					...
					$rutaImg = "Vistas/img/Paciente".$nombre.".png";
				...
				if($_FILES["imgPerfil"]["type"] == "image/jpeg"){
					...
					$rutaImg = "Vistas/img/Paciente".$nombre.".jpg";
			...
			if($resultado == true){
				...
				window.location = "http://localhost:8081/clinica/perfil-P/'.$_SESSION["id"].'";
				</script>';
