		...
		echo '<form method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						<img src="http://localhost:8081/clinica/'.$resultado["logo"].'" width="200px;">
						...
						<img src="http://localhost:8081/clinica/'.$resultado["favicon"].'" width="200px;">
		...
		if(isset($_POST["Iid"])){
			...
			if(isset($_FILES["favicon"]["tmp_name"]) && !empty($_FILES["favicon"]["tmp_name"])){
				...
				if($_FILES["favicon"]["type"] == "image/jpeg"){
					...
					$rutaFavicon = "http://localhost:8081/Vistas/img/favicon.jpeg";
				...
				if($_FILES["favicon"]["type"] == "image/png"){
					...
					$rutaFavicon = "http://localhost:8081/Vistas/img/favicon.png";
