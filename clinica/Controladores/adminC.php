...
class AdminC{
	...
	public function VerPerfilAdminC(){
		...
		echo '<tr>
				...
				echo '<td>
					<a href="http://localhost:8081/clinica/perfil-A/'.$resultado["id"].'">
		...
		if(isset($_POST["Aid"])){
			...
			if(isset($_FILES["imgP"]["tmp_name"]) && !empty($_FILES["imgP"]["tmp_name"])){
				...
				if($_FILES["imgP"]["type"] == "image/jpeg"){
					...
					$rutaImg = "Vistas/img/A-".$nombre.".jpg";
				...
				if($_FILES["imgP"]["type"] == "image/png"){
					...
					$rutaImg = "Vistas/img/A-".$nombre.".png";
			...
			if($resultado == true){
				...
				window.location = "http://localhost:8081/clinica/perfil-A/'.$resultado["id"].'";
				</script>';
