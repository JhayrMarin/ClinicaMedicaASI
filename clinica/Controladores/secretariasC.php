	...
	public function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				if($resultado["foto"] != ""){
					...
					echo '<td><img src="http://localhost:8081/clinica/'.$resultado["foto"].'" class="img-responsive" width="40px"></td>';

				}else{

					echo '<td><img src="http://localhost:8081/clinica/Vistas/img/defecto.png" class="img-responsive" width="40px"></td>';
				...
				echo '<td>
					...
					<a href="http://localhost:8081/clinica/perfil-S/'.$resultado["id"].'">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						if($resultado["foto"] == ""){
							...
							echo '<img src="http://localhost:8081/clinica/Vistas/img/defecto.png" width="200px;">';

						}else{

							echo '<img src="http://localhost:8081/clinica/'.$resultado["foto"].'" width="200px;">';
		...
		if(isset($_POST["idP"])){
			...
			if(isset($_FILES["imgP"]["tmp_name"]) && !empty($_FILES["imgP"]["tmp_name"])){
				...
				if($_FILES["imgP"]["type"] == "image/png"){
					...
					$rutaImg = "Vistas/img/S-".$nombre.".png";
			...
			if($resultado == true){
				...
				window.location = "http://localhost:8081/clinica/perfil-S/'.$_SESSION["id"].'";
				</script>';
